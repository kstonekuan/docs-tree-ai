...
fn test_config_loading() {
    ...
    assert_eq!(config.openai_api_base, "http://localhost:11434/v1");
    assert_eq!(config.openai_model_name, "test-model");
    assert_eq!(config.openai_api_key, "ollama"); // Should default to "ollama"
